...
if __name__ == "__main__":
    ...
    print("##################################\n")
    run_name = CHECKPOINT_PATH + reward_fn.__name__ + "_" + sys.argv[1]
    ...
    learner = Learner(build_rocketsim_env,
                      ...
                      wandb_group_name="unnamed group" if (not reward_fn.__name__) else (reward_fn.__name__),
    ...
    if len(sys.argv) == 2:
        ...
        if(bot_exists(sys.argv[1])):
            learner.load(CHECKPOINT_PATH + run_name + "/" + find_newest_checkpoint(run_name), LOG_TO_WANDB)
    elif len(sys.argv) == 3:
